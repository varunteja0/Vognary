...
const guardedMutationRoutes: Array<[string, number]> = [
  ...
  ["src/app/api/integrations/aa/start/route.ts", 1],
  ...
  ["src/app/api/profile/workspace/route.ts", 1],
  ...
  ["src/app/api/workspaces/current/control/proposals/[proposalId]/exception-reviews/route.ts", 1],
  ["src/app/api/workspaces/current/control/proposals/[proposalId]/outcome/route.ts", 1],
  ...
  ["src/app/api/workspaces/current/members/invites/route.ts", 1],
  ["src/app/api/workspaces/current/members/invites/[inviteId]/revoke/route.ts", 1],
  ...
  ["src/app/api/workspaces/current/autopilot/providers/[providerId]/disable/route.ts", 1],
  ["src/app/api/workspaces/current/autopilot/dead-letters/[deadLetterId]/replay/route.ts", 1],
  ["src/app/api/workspaces/current/autopilot/sources/[sourceId]/disconnect/route.ts", 1],
...
const mutationExceptions = [
  ...
  "src/app/api/webhooks/resend/notice/route.ts",
  "src/app/api/autopilot/veto/[token]/route.ts",
  ...
  "src/app/api/internal/autopilot/due/run/route.ts",
  "src/app/api/internal/autopilot/execute/route.ts",
  "src/app/api/internal/autopilot/providers/[providerId]/disable/route.ts",
...
test("all guarded JSON handlers use bounded parsing", () => {
  const boundedJsonRoutes = [
    ...
    "src/app/api/profile/workspace/route.ts",
    ...
    "src/app/api/workspaces/current/control/proposals/[proposalId]/exception-reviews/route.ts",
    "src/app/api/workspaces/current/control/proposals/[proposalId]/outcome/route.ts",
    ...
    "src/app/api/workspaces/current/members/invites/route.ts",
