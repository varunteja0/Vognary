    ...
    <main className="relative flex min-h-[78vh] items-center justify-center px-4 py-16 text-foreground">
      <div className="panel mx-auto w-full max-w-md p-8 text-center rise">
        ...
        <h1 className="mt-2 font-display text-3xl font-semibold tracking-[-0.02em] text-(--ink)">
          This page left no trail.
        </h1>
        <p className="mt-3 text-sm leading-6 text-(--muted)">
          The page you&rsquo;re looking for isn&rsquo;t here. Every debit leaves evidence &mdash; this one didn&rsquo;t.
        </p>
        <div className="mt-7 flex flex-wrap justify-center gap-2.5">
          <Link href="/" className="btn btn-primary">Back to the ledger</Link>
