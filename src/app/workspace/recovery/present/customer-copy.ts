export const customerPhrases = {
  ...
  billsQuietHint: "Nothing needs a decision here. Open a bill to inspect its cited history.",
  ...
  imageTimedOut: "This photo took too long to read. Confirm the line from the image, or paste the receipt text.",
  confirmNextBilling: "We found a future billing date, not a paid charge. Confirm only the fields printed in the image.",
