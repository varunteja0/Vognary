export const customerPhrases = {
  ...
  decideNowIntro: "These are decisions on money you already committed to. Vognary records intent; it never cancels or pays.",
  decideOnNow: "Decide on Now",
  billsLedgerHint: "Cited evidence — decide on Now.",
  billsQuietHint: "Nothing needs a decision. Add a bill from Sources or open a charge below.",
  ...
  confirmNextBilling: "The printed date is the next billing cycle, not a payment. Confirm only if it matches. Vognary does not invent money.",
  ...
  imageTimedOut: "The photo could not be read in time. Fill the line from the image, or paste the receipt text.",
