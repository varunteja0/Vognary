...
const terms = [
  ...
  ["11. Payments", "No public one-time audit or checkout is currently offered. Any future paid plan requires separately displayed scope, price, renewal, refund, tax, and provider-settlement terms before payment. A payment is settled only after the configured provider's signed webhook is verified."],
