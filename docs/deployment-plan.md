...
backups, and the public connector boundary (verified Gmail + production Account Aggregator) are actually configured or evidenced.
UPI/card mandate statuses remain visible in readiness and in `partner-rails:check`, but are not public-launch blockers while their UI stays honest and manual/partner-blocked.
