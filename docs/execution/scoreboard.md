...
| Product UX | 7.5 | 2026-08-18 | Value-first empty Home (add 2–5 bills before Gmail) is in code. Cited first-value Home + fail-closed Autopilot UI remains automated across desktop/mobile. Real-human <3 min remains unmeasured |
